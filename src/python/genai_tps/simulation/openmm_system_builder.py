"""OpenMM system construction and energy minimisation from PDB inputs.

Extracted from the former ``scripts/compute_cv_rmsd.py`` pipeline: explicit-solvent
TIP3P boxes, ligand GAFF2/OpenFF handling, and L-BFGS minimisation with Cα-RMSD
reporting.  The CLI remains in ``scripts/compute_cv_rmsd.py``.
"""
