...
_CV_LABEL_BY_NAME: dict[str, str] = {
    ...
    "end_to_end": r"End-to-end C$\alpha$ distance (\AA)",
    "ca_contact_count": r"C$\alpha$ long-range contact count",
    "shape_kappa2": r"Shape $\kappa^2$ (gyration)",
    "shape_acylindricity": r"Acylindricity $\lambda_2-\lambda_3$ (\AA$^2$)",
